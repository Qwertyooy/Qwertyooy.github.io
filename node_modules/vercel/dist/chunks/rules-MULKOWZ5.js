...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-CFTCULV5.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-CFTCULV5.js")).default(client, args);
    case "add":
      return (await import("./add-4F6CBPSE.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-2JWJRPGL.js")).default(client, args);
    case "rm":
      return (await import("./rm-FQB3M5YP.js")).default(client, args);
    case "update":
      return (await import("./update-T4SXDA7F.js")).default(client, args);
    default:
